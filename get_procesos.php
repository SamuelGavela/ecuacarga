...
<body>
    <?php
        ...
        $p_tipo_proceso = $_GET["p_tipo_proceso"];
        $conexion2 = conexion_bd();

        $array_result = lista_procesos($conexion2, $p_cliente, $p_tipo_proceso);
    ?>
        ...
        <select id="proceso_01" name="proceso_01" class="col-md-6 form-control" >
            ...
            <?php 
                ...
                { 
            ?>
                    <option value="<?php printf($array_result[$c_i]['nom_proceso']); ?>"><?php printf(utf8_encode($array_result[$c_i]['desc_proceso'])); ?></option>
            <?php 
                } 
            ?>
        </select> 
