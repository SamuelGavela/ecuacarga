    ...
    <script type="text/javascript" language="javascript" >
        $(document).ready(function() {
            ...
            $("#bt_generar").click(function() {
				...
				planes_01 = document.getElementById('planes_01').value;    
                sub_planes_01 = document.getElementById('sub_planes_01').value; 
				...
				if (sub_planes_01 == ""){
					Lobibox.notify('error', {
						...
						sound: false,
						title: 'DATOS INCOMPLETOS',
						msg: 'Debe seleccionar un SUB-PLAN para continuar' 
					}); 
				...
				if (validacion_ok)
				{
                    ...
                    var parametros = {
					  ...
					  "planes_01" : planes_01,
                      "sub_planes_01" : sub_planes_01
                    };
			
                    $.ajax({
                            data:  parametros,
                            url:   'generar_archivo_factura_nova.php',
                            type:  'post',
                   ...
                   <div class="row"  style="background-color: none;">
        				...
        				<div class="col-sm-12 col-md-12" style="background-color: none;">
                            <section id="content">
                                    ...
                                    <header>
										<span style="color:#333333; font-size:24px; padding-left: 5px;"><strong>Reporte para Facturar NOVA</strong></span>
									</header>
									</br>	
